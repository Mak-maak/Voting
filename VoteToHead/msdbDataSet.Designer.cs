...
namespace VoteToHead.msdbDataSetTableAdapters {
...
SELECT Id, Name, ErpNo, Class, Photo, Gender, Votes, [Voters Name], EventTime FROM Candidate WHERE (Id = @Id)";
        ...
        public virtual int Fill(msdbDataSet.CandidateDataTable dataTable) {
        ...
        public virtual msdbDataSet.CandidateDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            msdbDataSet.CandidateDataTable dataTable = new msdbDataSet.CandidateDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(msdbDataSet.CandidateDataTable dataTable) {
...
SELECT Id, Name, FatherName, ErpNo, Class, Gender, Photo, JoiningDate FROM Student WHERE (Id = SCOPE_IDENTITY())";
            this._adapter.InsertCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.InsertCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
...
SELECT Id, Name, FatherName, ErpNo, Class, Gender, Photo, JoiningDate FROM Student WHERE (Id = @Id)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
            this._adapter.UpdateCommand.Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@Name", global::System.Data.SqlDbType.VarChar, 0, global::System.Data.ParameterDirection.Input, 0, 0, "Name", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Fill, true)]
        public virtual int Fill(msdbDataSet.StudentDataTable dataTable) {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            if ((this.ClearBeforeFill == true)) {
                dataTable.Clear();
            }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Select, true)]
        public virtual msdbDataSet.StudentDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            msdbDataSet.StudentDataTable dataTable = new msdbDataSet.StudentDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        }
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(msdbDataSet.StudentDataTable dataTable) {
            return this.Adapter.Update(dataTable);
        }
        ...
        public virtual int Update(string Name, string FatherName, string ErpNo, string Class, string Gender, byte[] Photo, global::System.Nullable<global::System.DateTime> JoiningDate, int Original_Id, string Original_Name, string Original_FatherName, string Original_ErpNo, string Original_Class, string Original_Gender, global::System.Nullable<global::System.DateTime> Original_JoiningDate) {
            return this.Update(Name, FatherName, ErpNo, Class, Gender, Photo, JoiningDate, Original_Id, Original_Name, Original_FatherName, Original_ErpNo, Original_Class, Original_Gender, Original_JoiningDate, Original_Id);
        }
    }
